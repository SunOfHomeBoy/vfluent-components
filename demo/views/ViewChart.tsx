...
export default class ViewIcon extends ViewCommon {
        ...
        @Provide() dataChartDatasets0I: any[] = [{ label: '# 國內生產總值' }, { label: '第一產業' }, { label: '第二產業' }, { label: '第三產業' }]
        @Provide() dataChartDatasetsII: any[] = [{ label: '# 國內生產總值', type: 'line', fill: 'zero' }, { label: '第一產業' }, { label: '第二產業' }, { label: '第三產業' }]
                                ...
                                <section class="row">
                                        <div class="col-12 col-md-6">
                                                <Chart
                                                        ...
                                                        config={this.dataChartDatasets0I}
                                        ...
                                        <div class="col-12 col-md-6">
                                                <Chart
                                                        type="Bar"
                                                        labels={this.dataChartLabels}
                                                        config={this.dataChartDatasetsII}
                                                        data={this.dataChartData}
                                                />
                                        </div>
                                </section>
